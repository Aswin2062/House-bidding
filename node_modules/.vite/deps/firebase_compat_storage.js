...
function registerStorage2(instance) {
  ...
  instance.INTERNAL.registerComponent(new Component(STORAGE_TYPE2, factory2, "PUBLIC").setServiceProps(namespaceExports).setMultipleInstances(true));
